  ...
  return (
    ...
    <>
      ...
      <div className='w-full h-24 flex flex-row shadow-lg border-b-1 border-black justify-left items-center bg-gradient-to-r from-rose-100 to-teal-100'> 
        ...
        <motion.div className='mx-8' animate={{y: move2? -3: 0}} onHoverStart={()=> {setMove2(!move2)}} onHoverEnd={()=> {setMove2(!move2)}}><h1 className='uppercase text-lg'><a href="/home">home</a> </h1></motion.div>
