...
export default function DNavbar(props) {
  ...
  return (
    ...
    <>
      ...
      <div className='w-full h-24 flex flex-row shadow-lg border-b-1 border-black justify-left items-center bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r'> 
